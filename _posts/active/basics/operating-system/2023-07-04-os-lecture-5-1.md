...
- **Memory Space**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/memory-space.PNG)   

- **Protection of Memory Space**
    - 항상 체크해야하므로 하드웨어적으로 구성됨   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/protection.PNG)   
...
- **Address Binding**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/multistep.PNG)   
...
- **MMU (Memory Management Unit)**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/mmu.PNG)   
    - MMU 예시   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/mmu2.PNG)   
...
- **Memory Protection**   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/allocation-protection.PNG)   
...
- **Memory Allocation**   
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/allocation-partition.PNG)   
...
- **Basic Method for Paging**
    ...
    - 모든 주소는 CPU에 의해 두 부분으로 분리되어 생성된다.
        - A **Page Number (p)**
        - A **Page Offset (d)**   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/page.PNG)   

- **The Page Number**
    - 페이지 넘버는 각 프로세스의 **페이지 테이블(Page Table)**의 인덱스로 사용된다.   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/page-table.PNG)   
...
- **TLB(Translation Look-aside Buffer)**
    - 작고 빠른 **캐시 메모리**를 사용   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/tlb.PNG)   
...
- **Memory Protection with Paging**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/valid.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/libc.PNG)   
...
- **Hierarchical Paging**
    ...
    - Multiple Table   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/hierarchical-paging.PNG)   
- **Hashed Page Table**
    - 32비트보다 큰 주소 공간을 핸들링하기 위해 사용
    - O(1)   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/hash-page-table.PNG)   
- **Inverted Page Table**
    - 기존 페이지 테이블과 반대로 어떤 프로세스가 어떤 페이지 테이블을 가지고 있는지 관리
    - 즉, pid를 추가해주어서 프로세스별로 페이지 테이블을 관리한다는 개념   
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/inverted-page-table.PNG)   
...
- **Standard Swapping**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/standard-swapping.PNG)   
...
- **Swapping with Paging**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-1/swapping-with-paging.PNG)   
