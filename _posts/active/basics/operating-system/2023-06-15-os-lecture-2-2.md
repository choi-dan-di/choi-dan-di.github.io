...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/burst.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/dispatcher.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/gantt-fcfs.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/gantt-fcfs-2.PNG)   
또한 대기 시간도 각각 6, 0, 3으로 줄어들고 Total은 9, Average는 3이 될 것이다.

Turnaround Time의 간트 차트는 아래와 같다.

![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/gantt-fcfs-turn.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/sjf.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/gantt-srtf.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/gantt-rr-1.PNG)   

위와 같이 프로세스의 정보가 있고 Time Quantum이 4ms일 때, RR 정책의 간트 차트는 아래와 같다.

![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/gantt-rr-2.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/mlq.PNG)   

- 실시간 프로세스의 경우 우선순위가 높으며, 그 다음으로 시스템, 인터랙티브, 배치 순으로 낮아진다.

![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/mlq2.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-2/mlfq.PNG)   
