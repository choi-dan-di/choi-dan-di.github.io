...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/virtual-memory.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/page-sharing.PNG)   
...
- 어떠한 스토리지에 있는지 확인이 필요
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/valid-invalid.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/page-fault.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/copy-on-write.PNG)   
...
- **Page Fault Service Routine incl. Page Replacement**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/pr.PNG)   
...
- **Evaluation of Page Replacement Algorithms**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/frames.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/fifo.PNG)   
...
- **Belady's Anomaly**
    ...
    ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/belady.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/opt.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/lru.PNG)   
...
- **LRU-Approximation**
    ...
    - **Second-Chance Algorithm**
        ...
        ![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/second-chance.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/thrashing.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-5-2/working-set.PNG)   
