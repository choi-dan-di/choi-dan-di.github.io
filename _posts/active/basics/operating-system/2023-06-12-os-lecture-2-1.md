...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/thread.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/thread2.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/single.PNG)   
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/multi.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/amdahl.png)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/speedup.PNG)   
...
![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/thread-model.PNG)   

위 두 스레드 사이의 관계는 세 가지 모델이 있다.

- Many-to-One Model

![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/many-to-one.PNG)   

- One-to-One Model

![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/one-to-one.PNG)   

- Many-to-Many Model

![Alt Text](/assets/images/posts_img/active/basics/operating-system/os-lecture-2-1/many-to-many.PNG)   
